...
import com.tianjian.web.miservice.security.handler.*;
import com.tianjian.web.miservice.security.utils.security.JwtTokenUtil;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  /*  @Override
    ...
    @Override
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(myUserDetailService).passwordEncoder(
                new PasswordEncoder() {
    @Override
    ...
    public boolean matches(CharSequence rawPassword, String encodedPassword) {
        System.out.println(rawPassword+"-传过来的密码："+"用户密码："+encodedPassword);
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .loginProcessingUrl("/securitym/login")
            //登录成功跳转路径
            .successForwardUrl("/")
            //登录失败跳转路径
            .failureUrl("/")
